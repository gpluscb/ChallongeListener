...
public class TournamentTournamentTypeChangedEvent extends GenericTournamentChangedEvent {
	...
	public TournamentTournamentTypeChangedEvent(Tournament tournament, Tournament previousTournament,
			TournamentType tournamentType, TournamentType previousTournamentType) {
