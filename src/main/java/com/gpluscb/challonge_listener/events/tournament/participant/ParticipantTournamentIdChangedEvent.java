...
public class ParticipantTournamentIdChangedEvent extends GenericParticipantChangedEvent {
	...
	public ParticipantTournamentIdChangedEvent(Tournament tournament, Tournament previousTournament, Participant participant,
			Participant previousParticipant, Long tournamentTournamentId, Long previousTournamentId) {
